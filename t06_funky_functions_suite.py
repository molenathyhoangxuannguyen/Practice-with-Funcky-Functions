...
def testit(did_pass):
    ...
    :return: None
    """
    # This function works correctly--it is verbatim from the text, Chapter6
...
def funky_functions_suite():
    ...
    #testit(willoughby_wallaby([1,2,3]) == "W")
    print(type([1,2,3]))
    testit(willoughby_wallaby("[1,2,3]"))
    # Another bad type test... how should we handle cases like this?
